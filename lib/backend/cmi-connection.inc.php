 ...
 */
include_once("/var/www/html/lib/config.inc.php");
include_once("/var/www/html/lib/backend/uvr1611.inc.php");
include_once("/var/www/html/lib/backend/cmi-parser.inc.php");
include_once("/var/www/html/lib/backend/database.inc.php");
error_reporting(0);
